...
Fyk = Fy0;
for i = 1:300
    [Fxk,Fyk] = GVF(Fxk, Fyk, Fx0, Fy0, 0.01, 2);
end
Fx = Fxk;
Fy = Fyk;
...
function [Fxkp1,Fykp1] = GVF(Fxk, Fyk, Fx0, Fy0, gamma, mu)
    norm = Fx0 .* Fx0 + Fy0 .* Fy0;
    Fxkp1 = Fxk - gamma * (norm .* (Fxk - Fx0) - mu * del2(Fxk));
    Fykp1 = Fyk - gamma * (norm .* (Fyk - Fy0) - mu * del2(Fyk));
end
